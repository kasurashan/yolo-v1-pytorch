...
class YOLOv1(nn.Module):
    ...
    def _make_conv_layers(self, bn):
        if bn:
            net = nn.Sequential(
                nn.Conv2d(512, 1024, 3, padding=1),   # edit : 1024 -> 512
...
#resnet18_pretrained.fc = nn.Sequential()  #delete fc layer
#resnet18_pretrained.avgpool = nn.Sequential()   #delete avgpool  layer
resnet_edit = nn.Sequential(resnet18_pretrained.conv1, resnet18_pretrained.bn1, 
                            resnet18_pretrained.relu, resnet18_pretrained.maxpool,
                            resnet18_pretrained.layer1, resnet18_pretrained.layer2,
                            resnet18_pretrained.layer3, resnet18_pretrained.layer4)
print(resnet_edit)
